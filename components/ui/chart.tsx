...
>(({ className, ...props }, ref) => (
  <RechartsPrimitive.YAxis
    ref={ref}
    className={cn("[&_line]:stroke-border", className)}
...
ChartYAxis.displayName = RechartsPrimitive.YAxis.displayName
...
ChartXAxis.displayName = RechartsPrimitive.XAxis.displayName
